      ...
      >
        <View>
          ...
          <Text>
            <Text>
              <Text>
                <Text className="font-nunito-bold">Account</Text> means a unique
            ...
            <Text>
              <Text>
                <Text className="font-nunito-bold">Affiliate</Text> means an
            ...
            <Text>
              <Text>
                <Text className="font-nunito-bold">Application</Text> refers to
                PurrTalk - Cat Translator, the software program provided by the
                Company.
              </Text>
            </Text>
            <Text>
              <Text>
                <Text className="font-nunito-bold">Company</Text> (referred to
                as either &quot;the Company&quot;, &quot;We&quot;,
                &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to
                PurrTalk - Cat Translator.
              </Text>
            </Text>
            <Text>
              <Text>
                <Text className="font-nunito-bold">Country</Text> refers to:
                British Columbia, Canada
              </Text>
            </Text>
            <Text>
              <Text>
                <Text className="font-nunito-bold">Device</Text> means any
            ...
            <Text>
              <Text>
                <Text className="font-nunito-bold">Personal Data</Text> is any
            ...
            <Text>
              <Text>
                <Text className="font-nunito-bold">Service</Text> refers to the
                Application.
              </Text>
            </Text>
            <Text>
              <Text>
                <Text className="font-nunito-bold">Service Provider</Text> means
            ...
            <Text>
              <Text>
                <Text className="font-nunito-bold">Usage Data</Text> refers to
            ...
            <Text>
              <Text>
                <Text className="font-nunito-bold">You</Text> means the
          ...
          <Text>Collecting and Using Your Personal Data</Text>
          ...
          <Text>Information Collected while Using the Application</Text>
          <Text>
          ...
          <Text>
            ...
            <Text>
              <Text>
                <Text className="font-nunito-bold">To contact You:</Text> To
            ...
            <Text>
              <Text>
                <Text className="font-nunito-bold">To provide You</Text> with
            ...
            <Text>
              <Text>
                <Text className="font-nunito-bold">For other purposes</Text>: We
          ...
          <Text>
            <Text>
              <Text className="font-nunito-bold">With Service Providers:</Text>{" "}
              We may share Your personal information with Service Providers to
              monitor and analyze the use of our Service, to contact You.
            </Text>
            <Text>
              <Text className="font-nunito-bold">For business transfers:</Text>{" "}
            ...
            <Text>
              <Text className="font-nunito-bold">With Affiliates:</Text> We may
            ...
            <Text>
              <Text className="font-nunito-bold">With business partners:</Text>{" "}
              We may share Your information with Our business partners to offer
              You certain products, services or promotions.
            </Text>
            <Text>
              <Text className="font-nunito-bold">With other users:</Text> when
            ...
            <Text>
              <Text className="font-nunito-bold">With Your consent</Text>: We
              may disclose Your personal information for any other purpose with
              Your consent.
            </Text>
          </Text>
          <Text>Retention of Your Personal Data</Text>
          <Text>
          ...
          <Text>Transfer of Your Personal Data</Text>
          <Text>
          ...
          <Text>Delete Your Personal Data</Text>
          <Text>
          ...
          <Text>By email: kanakofukuda199531@gmail.com</Text>
        </View>
      </ScrollView>
    </View>
  );
